...
function LoginPageCtrl($http, $location, ToDoListService, dbService, loginPageService) {
    ...
    this.logIn = function () {
        this.loginPageService.logIn(this.user, this.globalStorage, this.dbService, this.location);
    };
    this.registration = function () {
        this.loginPageService.registration(this.user, this.checkPassword, this.globalStorage, this.dbService, this.location);
    };
}
...
ToDoListService.prototype.getData = function (dbService) {
    ...
    dbService.getData(user).then(function (result) {
